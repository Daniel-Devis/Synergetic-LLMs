...
test_jsonl_file = r'D:\danie\Documents\CSC-40040 19020322 code\FocalM\test\extracted_1.jsonl'
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for i, line in enumerate(f, start=1):
                try:
                    ...
                    if 'focal_class' in json_data:
                        focal_methods.append(json_data['focal_class'])
                        print(f"Line {i}: Focal method collected")
                    else:
                        print(f"Line {i}: 'focal_class' key not found")
...
for focal_method in test_focal_methods:
    response = client.chat.completions.create(
      model='ft:gpt-3.5-turbo-0125:personal::9wAFewSr',  # Replace with your actual fine-tuned model ID
      messages=[
...
output_file = 'D:/danie/Documents/Disso/predictions.json'
