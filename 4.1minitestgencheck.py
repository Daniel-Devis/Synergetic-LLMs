...
input_json_file = 'D:/danie/Documents/Disso/data/4.1minipredictions.json'
output_json_file = 'D:/danie/Documents/Disso/4.1minireviewed_test_cases.json'
...
for entry in test_case_data:
    ...
    response = client.chat.completions.create(
        model='ft:gpt-4.1-mini-2025-04-14:personal::CELffg9H',  # Ensure this is the correct model ID for your review model
        messages=[
